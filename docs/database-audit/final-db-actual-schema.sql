...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_Blog_DuongDan] ON [Blog] ([duong_dan]);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_CommentModerationKeyword_TuKhoa] ON [CommentModerationKeyword] ([tu_khoa]);
GO
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_GiaoDichThanhToan_Ma] ON [GiaoDichThanhToan] ([ma_giao_dich]);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_HoaDon_Ma] ON [HoaDon] ([ma_don_hang]);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_PhieuGiamGia_Ma] ON [PhieuGiamGia] ([ma_phieu]);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_SanPhamChiTiet_UniqueAttrs] ON [SanPhamChiTiet] ([id_san_pham]);
CREATE UNIQUE NONCLUSTERED INDEX [UQ_SanPhamChiTiet_UniqueAttrs] ON [SanPhamChiTiet] ([mau_sac]);
CREATE UNIQUE NONCLUSTERED INDEX [UQ_SanPhamChiTiet_UniqueAttrs] ON [SanPhamChiTiet] ([trong_luong]);
CREATE UNIQUE NONCLUSTERED INDEX [UQ_SanPhamChiTiet_UniqueAttrs] ON [SanPhamChiTiet] ([muc_cang]);
...
CREATE UNIQUE NONCLUSTERED INDEX [UK_principal_name] ON [sysdiagrams] ([principal_id]);
CREATE UNIQUE NONCLUSTERED INDEX [UK_principal_name] ON [sysdiagrams] ([name]);
GO
