...
BEGIN TRY
    ...
    SELECT
        m.id_khach_hang, NULL, d.id_pttt, NULL,
    ...
    FROM (VALUES
        -- KỲ TRƯỚC (D01 -> D20)
        ('D01', 'C01', 5, '2026-06-22 09:15:00', '2026-06-22 09:16:30', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'an.nguyen@example.com', NULL, 'SP_DEMO_202606220915_C01'),
        ('D02', 'C02', 2, '2026-06-24 14:20:00', '2026-06-24 14:21:45', 5650000.00, 97400.00, 0.00, 5747400.00, N'da_giao', N'DA_THANH_TOAN', 'binh.tran@example.com', NULL, 'VNP_DEMO_202606241420_C02'),
        ('D03', 'C03', 1, '2026-06-26 10:30:00', '2026-06-28 11:00:00', 4190000.00, 97400.00, 0.00, 4287400.00, N'da_giao', N'DA_THANH_TOAN', 'cuong.le@example.com', NULL, NULL),
        ('D04', 'C04', 3, '2026-06-28 16:45:00', '2026-06-28 16:46:12', 4709000.00, 97400.00, 0.00, 4806400.00, N'da_giao', N'DA_THANH_TOAN', 'duc.pham@example.com', NULL, 'MM_DEMO_202606281645_C04'),
        ('D05', 'C05', 5, '2026-06-30 11:10:00', '2026-06-30 11:11:05', 4490000.00, 97400.00, 0.00, 4587400.00, N'da_giao', N'DA_THANH_TOAN', 'hanh.do@example.com', NULL, 'SP_DEMO_202606301110_C05'),
        ('D06', 'C06', 1, '2026-07-02 08:50:00', '2026-07-04 09:30:00', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'khoi.hoang@example.com', NULL, NULL),
        ('D07', 'C07', 2, '2026-07-03 15:30:00', '2026-07-03 15:31:20', 5650000.00, 97400.00, 0.00, 5747400.00, N'da_giao', N'DA_THANH_TOAN', 'lan.vu@example.com', NULL, 'VNP_DEMO_202607031530_C07'),
        ('D08', 'C08', 5, '2026-07-05 19:20:00', '2026-07-05 19:22:10', 4190000.00, 97400.00, 0.00, 4287400.00, N'da_giao', N'DA_THANH_TOAN', 'nam.bui@example.com', NULL, 'SP_DEMO_202607051920_C08'),
        ('D09', 'C01', 5, '2026-07-07 10:15:00', '2026-07-07 10:16:00', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'an.nguyen@example.com', NULL, 'SP_DEMO_202607071015_C01'),
        ('D10', 'C02', 3, '2026-07-09 14:00:00', '2026-07-09 14:01:30', 4709000.00, 97400.00, 0.00, 4806400.00, N'da_giao', N'DA_THANH_TOAN', 'binh.tran@example.com', NULL, 'MM_DEMO_202607091400_C02'),
        ('D11', 'C03', 1, '2026-07-11 17:35:00', '2026-07-13 18:00:00', 5650000.00, 97400.00, 0.00, 5747400.00, N'da_giao', N'DA_THANH_TOAN', 'cuong.le@example.com', NULL, NULL),
        ('D12', 'C04', 2, '2026-07-13 09:40:00', '2026-07-13 09:42:00', 4490000.00, 97400.00, 0.00, 4587400.00, N'da_giao', N'DA_THANH_TOAN', 'duc.pham@example.com', NULL, 'VNP_DEMO_202607130940_C04'),
        ('D13', 'C05', 5, '2026-07-15 13:25:00', '2026-07-15 13:26:40', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'hanh.do@example.com', NULL, 'SP_DEMO_202607151325_C05'),
        ('D14', 'C06', 1, '2026-07-17 16:10:00', '2026-07-19 16:40:00', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'khoi.hoang@example.com', NULL, NULL),
        ('D15', 'C07', 5, '2026-07-19 20:05:00', '2026-07-19 20:06:15', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'lan.vu@example.com', NULL, 'SP_DEMO_202607192005_C07'),
        ('D16', 'C08', 1, '2026-06-25 11:00:00', NULL, 4190000.00, 97400.00, 0.00, 4287400.00, N'dang_giao', N'CHO_THANH_TOAN', 'nam.bui@example.com', NULL, NULL),
        ('D17', 'C01', 5, '2026-07-10 15:00:00', NULL, 5099000.00, 97400.00, 0.00, 5196400.00, N'cho_xac_nhan', N'CHO_THANH_TOAN', 'an.nguyen@example.com', NULL, 'SP_DEMO_202607101500_C01'),
        ('D18', 'C02', 1, '2026-06-27 09:30:00', NULL, 4709000.00, 97400.00, 0.00, 4806400.00, N'da_huy', N'CHO_THANH_TOAN', 'binh.tran@example.com', N'Khách đổi ý muốn mua màu khác', NULL),
        ('D19', 'C03', 1, '2026-07-06 14:40:00', NULL, 5650000.00, 97400.00, 0.00, 5747400.00, N'da_huy', N'CHO_THANH_TOAN', 'cuong.le@example.com', N'Trùng đơn hàng', NULL),
        ('D20', 'C04', 1, '2026-07-18 18:20:00', NULL, 4490000.00, 97400.00, 0.00, 4587400.00, N'da_huy', N'CHO_THANH_TOAN', 'duc.pham@example.com', N'Thời gian giao hàng lâu', NULL),

        -- KỲ HIỆN TẠI (D21 -> D41)
        ('D21', 'C09', 5, '2026-07-22 09:30:00', '2026-07-22 09:31:15', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'ngoc.phan@example.com', NULL, 'SP_DEMO_202607220930_C09'),
        ('D22', 'C10', 2, '2026-07-24 14:15:00', '2026-07-24 14:16:40', 4190000.00, 97400.00, 0.00, 4287400.00, N'da_giao', N'DA_THANH_TOAN', 'phuong.trinh@example.com', NULL, 'VNP_DEMO_202607241415_C10'),
        ('D23', 'C11', 1, '2026-07-26 10:45:00', '2026-07-28 11:30:00', 5650000.00, 97400.00, 0.00, 5747400.00, N'da_giao', N'DA_THANH_TOAN', 'quan.dang@example.com', NULL, NULL),
        ('D24', 'C12', 3, '2026-07-27 16:20:00', '2026-07-27 16:21:10', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'quynh.mai@example.com', NULL, 'MM_DEMO_202607271620_C12'),
        ('D25', 'C01', 5, '2026-07-29 11:05:00', '2026-07-29 11:06:20', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'an.nguyen@example.com', NULL, 'SP_DEMO_202607291105_C01'),
        ('D26', 'C13', 2, '2026-07-31 15:40:00', '2026-07-31 15:41:50', 4709000.00, 97400.00, 0.00, 4806400.00, N'da_giao', N'DA_THANH_TOAN', 'son.ha@example.com', NULL, 'VNP_DEMO_202607311540_C13'),
        ('D27', 'C14', 5, '2026-08-02 08:30:00', '2026-08-02 08:31:05', 4490000.00, 97400.00, 0.00, 4587400.00, N'da_giao', N'DA_THANH_TOAN', 'tam.ngo@example.com', NULL, 'SP_DEMO_202608020830_C14'),
        ('D28', 'C15', 1, '2026-08-04 19:15:00', '2026-08-06 20:00:00', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'tuan.duong@example.com', NULL, NULL),
        ('D29', 'C16', 3, '2026-08-06 10:50:00', '2026-08-06 10:51:30', 4190000.00, 97400.00, 0.00, 4287400.00, N'da_giao', N'DA_THANH_TOAN', 'uyen.vo@example.com', NULL, 'MM_DEMO_202608061050_C16'),
        ('D30', 'C17', 5, '2026-08-08 14:35:00', '2026-08-08 14:36:25', 5650000.00, 97400.00, 0.00, 5747400.00, N'da_giao', N'DA_THANH_TOAN', 'vinh.truong@example.com', NULL, 'SP_DEMO_202608081435_C17'),
        ('D31', 'C18', 1, '2026-08-09 17:00:00', '2026-08-11 17:45:00', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'yen.lam@example.com', NULL, NULL),
        ('D32', 'C03', 2, '2026-08-11 09:20:00', '2026-08-11 09:22:15', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'cuong.le@example.com', NULL, 'VNP_DEMO_202608110920_C03'),
        ('D33', 'C09', 5, '2026-08-12 13:45:00', '2026-08-12 13:46:30', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'ngoc.phan@example.com', NULL, 'SP_DEMO_202608121345_C09'),
        ('D34', 'C10', 3, '2026-08-14 16:10:00', '2026-08-14 16:11:40', 4709000.00, 97400.00, 0.00, 4806400.00, N'da_giao', N'DA_THANH_TOAN', 'phuong.trinh@example.com', NULL, 'MM_DEMO_202608141610_C10'),
        ('D35', 'C11', 5, '2026-08-15 11:25:00', '2026-08-15 11:26:10', 4190000.00, 97400.00, 0.00, 4287400.00, N'da_giao', N'DA_THANH_TOAN', 'quan.dang@example.com', NULL, 'SP_DEMO_202608151125_C11'),
        ('D36', 'C12', 1, '2026-08-16 15:50:00', '2026-08-18 16:20:00', 5650000.00, 97400.00, 0.00, 5747400.00, N'da_giao', N'DA_THANH_TOAN', 'quynh.mai@example.com', NULL, NULL),
        ('D37', 'C13', 2, '2026-08-17 08:40:00', '2026-08-17 08:41:20', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'son.ha@example.com', NULL, 'VNP_DEMO_202608170840_C13'),
        ('D38', 'C06', 5, '2026-08-17 14:10:00', '2026-08-17 14:11:15', 5099000.00, 97400.00, 0.00, 5196400.00, N'da_giao', N'DA_THANH_TOAN', 'khoi.hoang@example.com', NULL, 'SP_DEMO_202608171410_C06'),
        ('D39', 'C14', 3, '2026-08-18 10:00:00', '2026-08-18 10:01:45', 300000.00, 97400.00, 0.00, 397400.00, N'da_giao', N'DA_THANH_TOAN', 'tam.ngo@example.com', NULL, 'MM_DEMO_202608181000_C14'),
        ('D40', 'C15', 1, '2026-08-13 10:30:00', NULL, 4190000.00, 97400.00, 0.00, 4287400.00, N'dang_giao', N'CHO_THANH_TOAN', 'tuan.duong@example.com', NULL, NULL),
        ('D41', 'C16', 1, '2026-08-07 16:00:00', NULL, 4709000.00, 97400.00, 0.00, 4806400.00, N'da_huy', N'CHO_THANH_TOAN', 'uyen.vo@example.com', N'Khách muốn hủy đặt lại', NULL)
    ) AS d(order_code, cust_code, id_pttt, ngay_tao, ngay_thanh_toan, tien_hang, phi_van_chuyen, so_tien_giam_gia, tong_tien, trang_thai_don_hang, trang_thai_thanh_toan, email, ly_do_huy, ma_giao_dich)
    JOIN @CustMap m ON m.cust_code = d.cust_code;

    PRINT N'==> [5/5] Khởi tạo 47 Dòng Chi tiết Hóa đơn (HoaDonChiTiet)...';
